...
import com.terdev.colosseum.bd.system.ChatDao
...
class ChatDaoImpl(connectionSource: ConnectionSource?) : BaseDaoImpl<Chat, Long>(connectionSource, Chat::class.java),
    ChatDao {
