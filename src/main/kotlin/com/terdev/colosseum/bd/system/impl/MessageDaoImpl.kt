...
import com.terdev.colosseum.bd.system.MessageDao
...
class MessageDaoImpl(connectionSource: ConnectionSource?) :
    BaseDaoImpl<Message, Long>(connectionSource, Message::class.java), MessageDao {
    ...
    override fun saveIfNotExist(messageTG: org.telegram.telegrambots.meta.api.objects.Message?) {
        if (messageTG != null)
            if (findById(messageTG.messageId) == null) {
                ...
                com.terdev.colosseum.utils.println("------------------------------KAK--------------------------")
            }
    }
