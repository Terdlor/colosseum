package com.example.terdlor_first_bot.bd.chat.model
...
class Chat {
    ...
    override fun toString() : String {
        ...
        strBuild.append("{")
                ...
                .append("description=$description").append("inviteLink=$inviteLink, ").append("pinnedMessageId=$pinnedMessageId, ")
                .append("stickerSetName=$stickerSetName").append("canSetStickerSet=$canSetStickerSet, ")
                .append("permissionsCanSendMessages=$permissionsCanSendMessages").append("permissionsCanSendMediaMessages=$permissionsCanSendMediaMessages, ").append("permissionsCanSendPolls=$permissionsCanSendPolls, ")
